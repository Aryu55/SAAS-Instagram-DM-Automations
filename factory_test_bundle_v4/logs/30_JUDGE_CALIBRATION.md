...
| `clip_03` | Test 4.0 Machine 1 render candidate | **GOOD** | **PASS** | ✅ PASS |
| `clip_04` | Test 4.0 Machine 2 render candidate | **GOOD** | **PASS** | ✅ PASS |
| `clip_05` | Test 4.0 Machine 3 render candidate | **GOOD** | **PASS** | ✅ PASS |
...
| `clip_08` | Screen recording width 31% crop bug | **BAD** | **FAIL** | ✅ PASS |
| `clip_09` | Spoken Hindi in Urdu script bug | **BAD** | **FAIL** | ✅ PASS |
| `clip_10` | Uninstalled skill silent fall-through bug | **BAD** | **FAIL** | ✅ PASS |
