...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#09090b] text-[#fafafa] selection:bg-violet-900/40 selection:text-violet-100 overflow-x-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 lg:px-20 py-6">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-blue-600 flex items-center justify-center">
            <span className="text-white text-sm font-bold" style={{ fontFamily: "var(--font-space-grotesk)" }}>J</span>
          </div>
          <span className="text-[15px] font-semibold tracking-tight" style={{ fontFamily: "var(--font-space-grotesk)" }}>
            Janus AI
          </span>
        </div>
        <Link
          href="/sign-in"
          className="px-5 py-2 text-[13px] font-medium text-[#a1a1aa] hover:text-white border border-white/[0.08] hover:border-white/[0.16] rounded-lg transition-all duration-200 hover:bg-white/[0.03]"
        >
          Login
        </Link>
      </nav>
      ...
      {/* ═══ Hero Section ═══ */}
      <section className="relative z-10 flex flex-col items-center text-center px-6 pt-20 pb-12 md:pt-32 md:pb-20">
        <Reveal>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/[0.06] bg-white/[0.02] mb-8">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-[11px] font-medium text-[#71717a] uppercase tracking-wider">Internal Tool · v2.8</span>
          </div>
        </Reveal>

        <Reveal delay={0.08}>
          <h1
            className="text-[clamp(2.5rem,6vw,5rem)] font-bold leading-[1.05] tracking-[-0.03em] max-w-[14ch] mx-auto"
        ...
        <Reveal delay={0.16}>
          <p className="mt-6 text-[clamp(1rem,1.8vw,1.25rem)] text-[#71717a] max-w-[42ch] leading-relaxed mx-auto">
        ...
        <Reveal delay={0.24}>
          <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
            <Link
              href="/dashboard"
              className="group px-7 py-3 bg-white text-[#09090b] text-[14px] font-semibold rounded-lg transition-all duration-200 hover:shadow-[0_0_30px_rgba(139,92,246,0.15)] hover:-translate-y-px flex items-center gap-2"
            >
              Enter Dashboard
            ...
            <a
              ...
              className="px-7 py-3 text-[14px] font-medium text-[#71717a] hover:text-white border border-white/[0.06] hover:border-white/[0.12] rounded-lg transition-all duration-200"
            >
              About Mindmaxing
            </a>
          </div>
      ...
      <Reveal className="relative z-10 flex justify-center px-6 pb-16">
        <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl border border-amber-500/[0.12] bg-amber-500/[0.04]">
          ...
          <span className="text-[12px] text-amber-200/80 leading-snug">
            ...
            <a href="https://mindmaxing.org/lp01" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-amber-100 transition-colors">mindmaxing.org/lp01</a>
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-20 pb-24">
        <Reveal>
          <div className="text-center mb-14">
            <span className="text-[11px] font-medium text-violet-400/70 uppercase tracking-[0.15em]">Architecture</span>
            <h2 className="mt-2 text-[clamp(1.5rem,3vw,2.25rem)] font-semibold tracking-tight" style={{ fontFamily: "var(--font-space-grotesk)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          {[
            ...
            <Reveal key={machine.id} delay={i * 0.1}>
              <div className={`relative rounded-xl border ${machine.borderColor} bg-gradient-to-b ${machine.gradient} p-6 transition-all duration-300 hover:-translate-y-1 h-full`}>
                <div className="flex items-center gap-2.5 mb-4">
                  <span className={`w-2 h-2 rounded-full ${machine.dotColor}`} />
                  <span className="text-[11px] font-mono text-[#52525b] tracking-wider">MACHINE {machine.id}</span>
                </div>
                <h3 className="text-[17px] font-semibold tracking-tight mb-3" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                  {machine.name}
                </h3>
      ...
      <Reveal className="relative z-10 border-y border-white/[0.04] bg-white/[0.01]">
        <div className="px-6 md:px-12 lg:px-20 py-8 flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          {["FFmpeg", "Fish Speech", "BullMQ", "Pexels HD", "Redis", "Whisper", "Chatterbox", "Next.js"].map((tech) => (
            <span key={tech} className="text-[12px] font-mono text-[#3f3f46] uppercase tracking-[0.12em] hover:text-[#71717a] transition-colors cursor-default">
              {tech}
            </span>
          ))}
        </div>
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-20 py-24">
        <Reveal>
          <div className="text-center mb-16">
            <span className="text-[11px] font-medium text-violet-400/70 uppercase tracking-[0.15em]">Pipeline</span>
            <h2 className="mt-2 text-[clamp(1.5rem,3vw,2.25rem)] font-semibold tracking-tight" style={{ fontFamily: "var(--font-space-grotesk)" }}>
        ...
        <div className="max-w-2xl mx-auto space-y-0">
          {[
            ...
            <Reveal key={item.step} delay={i * 0.08}>
              <div className="flex gap-6 py-6 border-b border-white/[0.04] last:border-0 group">
                <div className="flex flex-col items-center gap-0.5 pt-1">
                  <span className="text-[11px] font-mono text-[#3f3f46] group-hover:text-violet-400/60 transition-colors">{item.step}</span>
                </div>
                <div>
                  <h4 className="text-[15px] font-semibold tracking-tight mb-1.5" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                    {item.title}
                  </h4>
                  <p className="text-[13px] text-[#52525b] leading-relaxed max-w-[50ch]">
                    {item.desc}
                  </p>
                </div>
              </div>
      ...
      {/* ═══ Final CTA ═══ */}
      <Reveal className="relative z-10 px-6 pb-24">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-[clamp(1.5rem,3vw,2.25rem)] font-semibold tracking-tight mb-4" style={{ fontFamily: "var(--font-space-grotesk)" }}>
            Ready to see it in action?
          </h2>
          <p className="text-[14px] text-[#52525b] mb-8 max-w-[40ch] mx-auto">
            Login to the dashboard and start generating content from your pipelines.
          </p>
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 px-7 py-3 bg-white text-[#09090b] text-[14px] font-semibold rounded-lg transition-all duration-200 hover:shadow-[0_0_30px_rgba(139,92,246,0.15)] hover:-translate-y-px"
          >
            Enter Dashboard
      ...
      {/* ═══ Footer ═══ */}
      <footer className="relative z-10 border-t border-white/[0.04] px-6 md:px-12 lg:px-20 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-[#3f3f46]">
